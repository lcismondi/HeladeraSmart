...
void loop() {
  ...
  while (millis() - comu <= 40)
  {
    //=7,1213*D2-11683
    //adc.getResult_V();
    //adc.getRawResult();
    voltage = adc.getResult_mV();
    rms = voltage*voltage + rms;
    Nmed++;
  }

  //Serial.print("Tensión: ");
  Serial.println(sqrt(rms / Nmed));
  //Serial.print(" Muestras: ");
  //Serial.print(Nmed);
  //Serial.print(" Tiempo: ");
  //Serial.println(millis()-comu);
  ...
  while (millis() - comu <= 40)
  {
    ...
    //adc.getResult_V();
    //adc.getRawResult();
    amperaje = adc.getResult_mV();
    rms = amperaje*amperaje + rms;
    Nmed++;
  }

  Serial.print("Corriente: ");
  Serial.print(7.1213 * sqrt(rms / Nmed) - 11683);
  Serial.print(" Muestras: ");
  Serial.print(Nmed);
  Serial.print(" Tiempo: ");
  Serial.println(millis()-comu);
